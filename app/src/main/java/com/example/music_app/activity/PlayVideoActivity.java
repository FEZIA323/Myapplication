...
public class PlayVideoActivity extends Activity implements View.OnClickListener{
    ...
    private void init(){
        ...
        btn_update_bag=findViewById(R.id.btn_update_bag);
        ...
        btn_update_bag.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if(choosebag==1){
                    choosebag=2;
                    Glide.with(PlayVideoActivity.this).load(R.mipmap.bofangqibg).into(iv_music);
                }else {
                    choosebag=1;
                    Glide.with(PlayVideoActivity.this).load(R.mipmap.tupian).into(iv_music);
                }
